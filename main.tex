...
\abstract{The core-cusp problem is often seen as motivating the exploration of a wider variety of dark matter models. One such scenario is ULDM [ultra-light dark matter], which  proposes that dark matter consists of ultralight particles exhibiting wavelike properties on kiloparsec scales. ULDM obeys the Schr\"{o}dinger-Poisson equation and has soliton-like solutions consisting of gravitationally bound condensates with no internal kinetic energy; however astrophysically realistic ULDM halos would  consist of a larger NFW-like configurations with a possible solitonic core. We generate ``synthetic'' ULDM halos by numerically colliding a number of individual solitons; this computationally efficient strategy precludes any analysis of the evolutionary history of halos or ``environmental'' interactions, but does allow us to create large numbers of prototype halos and multiple realisations of these scenarios apparently evolve towards broadly similar final states. \re{I guess/hope?!!!!!} We formulate an empirical parameterisation for the radial density profiles of these synthetic halos, showing that ULDM can -- at least in principle -- fit the observed density profiles \re{some set of?? how to say this} galaxies as least as well as standard cold dark matter. }
